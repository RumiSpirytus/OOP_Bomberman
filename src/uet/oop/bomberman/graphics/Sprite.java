...
public class Sprite {
	...
	public static Sprite grass1 = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.grass1, 16, 16);
	public static Sprite brick = new Sprite(DEFAULT_SIZE, 7, 0, SpriteSheet.tiles, 16, 16);
	public static Sprite brick1 = new Sprite(DEFAULT_SIZE, 0, 0, SpriteSheet.brick1, 16, 16);
